...
Print '***Inicio de creacion de tablas***'
	...
	CREATE TABLE LOOPP.Empresas(
		...
		fecha_creacion datetime NULL DEFAULT ('No definido'),
		...
		direccion_nro numeric(18, 0) NULL DEFAULT ('No definido'),
		direccion_piso numeric(18, 0) NULL DEFAULT ('No definido'),
	...
	CREATE TABLE LOOPP.Clientes(
		...
		fecha_nacimiento datetime NULL DEFAULT ('No definido'),
		fecha_creacion datetime NULL DEFAULT ('No definido'),
		id_usuario int NOT NULL,
